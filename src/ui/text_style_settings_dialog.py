...
class TextStyleSettingsDialog(QDialog):
    ...
    def _init_ui(self):
        ...
        main_color_layout.addWidget(main_color_label); main_color_layout.addWidget(self.text_main_color_edit, 1)
        ...
        outline_color_layout.addWidget(outline_color_label); outline_color_layout.addWidget(self.text_outline_color_edit, 1)
        ...
        outline_thickness_layout.addWidget(outline_thickness_label); outline_thickness_layout.addWidget(self.text_outline_thickness_edit, 0)
